                    ...
                    <OnClickOutsideWrapper handleDismissal={this.closeDropdown}>
                        <div className="NavDropdown-content right">
                            <ul className="NavDropdown-content-layer">
                                ...
                                <li>
                                    <a data-metabase-event={"Navbar;Profile Dropdown;Help "+tag} className="Dropdown-item block text-white no-decoration" href={"http://www.eKomi.com/docs/"+tag} target="_blank">
                                        Help
                                    </a>
                                </li>
                ...
                { modalOpen === "about" ?
                    <Modal small onClose={this.closeModal}>
                        <div className="px4 pt4 pb2 text-centered relative">
                            ...
                            <h2 style={{fontSize: "1.75em"}} className="text-dark">Thanks for using eKomi!</h2>
                            <div className="pt2">
                        ...
                        <div style={{borderWidth: "2px"}} className="p2 h5 text-centered text-grey-3 border-top">
                            <span className="block"><span className="text-bold">eKomi</span> is a Trademark of eKomi, Inc</span>
