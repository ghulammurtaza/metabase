            ...
            <form noValidate>
                ...
                >
                    ...
                    <p className="text-grey-4">
                        {t`Allows users with existing eKomi accounts to login with a Google account that matches their email address in addition to their Metabase username and password.`}
                    </p>
                    <p className="text-grey-4">
                        {jt`To allow users to sign in with Google you'll need to give eKomi a Google Developers console application client ID. It only takes a few steps and instructions on how to create a key can be found ${<a className="link" href="https://developers.google.com/identity/sign-in/web/devconsole-project" target="_blank">here.</a>}`}
                    </p>
                    <Input
