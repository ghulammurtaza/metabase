            ...
            <ul className="text-measure">
                <li>
                    <div className="bordered rounded shadowed bg-white p4">
                        ...
                        <p>{t`Allows users with existing eKomi accounts to login with a Google account that matches their email address in addition to their Metabase username and password.`}</p>
                ...
                <li className="mt2">
                    <div className="bordered rounded shadowed bg-white p4">
                        <h2>{t`LDAP`}</h2>
                        <p>{t`Allows users within your LDAP directory to log in to eKomi with their LDAP credentials, and allows automatic mapping of LDAP groups to Metabase groups.`}</p>
